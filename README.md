...
```bash
  git clone https://github.com/prashantchaudhary30/HospitalApi.git
```
...
Data that needs to be sent with a route :
    ...
    c. /patients/register - JWT Token (In Headers), name, phone, age, sex, comorbidity status (Form type data),doctorId.
